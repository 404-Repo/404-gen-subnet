...
| Texture data (all `DataTexture` buffers via materials) | 1,048,576 bytes (1 MB) |
...
| `FORBIDDEN_THREE_API` | Used `THREE.X` where X is not on the allowlist |
...
| `TEXTURE_DATA_EXCEEDED` | More than 1 MB texture data |
